        ...
        <div>
            <Navbar fluid rounded className='bg-blue-400'>
                ...
                <Navbar.Collapse>
                    ...
                    <Navbar.Link href="#" className='text-xl text-black font-semibold'>Services</Navbar.Link>
                    <Navbar.Link href="#" className='text-xl text-black font-semibold'>Packages</Navbar.Link>
                    <Navbar.Link href="#" className='text-xl text-black font-semibold'>Contact</Navbar.Link>
                </Navbar.Collapse>
            </Navbar>
        </div>
    )
